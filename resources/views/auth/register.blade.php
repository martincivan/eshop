            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="business_id" class="col-md-4 col-form-label text-md-right">{{ __('Business ID') }}</label>

                            <div class="col-md-6">
                                <input id="business_id" type="text" class="form-control{{ $errors->has('business_id') ? ' is-invalid' : '' }}" name="business_id" value="{{ old('business_id') }}" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="zip" type="text" class="form-control{{ $errors->has('zip') ? ' is-invalid' : '' }}" name="zip" value="{{ old('zip') }}" autofocus>
